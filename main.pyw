...
#MOVIMIENTO RAQUETA
    ...
    if pelota_x <=0 or pelota_x + LADO_PELOTA >=ANCHO_VENTANA:
    ...
    if pelota_x<=raqueta_x + ANCHO_RAQUETA and pelota_x>=raqueta_x and pelota_y>=RAQUETA_Y - LADO_PELOTA and pelota_y<=RAQUETA_Y + ALTO_RAQUETA and VELOCIDAD_PELOTA_Y < 0:
        VELOCIDAD_PELOTA_Y = -VELOCIDAD_PELOTA_Y        
